...
export default class HarvestADScene extends Phaser.Scene {
  constructor() {
  ...
  create() {
    ...
    this.add
      .bitmapText(
        ...
        Config.height / 2 + 30,
        "pixelFont",
        `Token AD'S  ${this.m_mobsKilled}+${this.m_level}`,
        40
      )
      .setOrigin(0.5);

    new Button(Config.width / 2, Config.height / 2 + 180, "HARVEST", this, () =>
